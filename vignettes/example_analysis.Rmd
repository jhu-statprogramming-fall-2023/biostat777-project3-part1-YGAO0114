...
```{r}
cols <- c(
    # unemployment related variables: female vs. male
    'funr_16', 'munr_16', 
    # Labor force participation rate of the female population aged 20 to 64 years old who have children under diff age group: under 6 vs. 6-17

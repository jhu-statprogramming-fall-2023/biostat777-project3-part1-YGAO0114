...
- I use bslib to set various color properties for the theme, ensuring a consistent and appealing design.  

- The bg property sets the background color to a light gray (#eaeaec), creating a neutral canvas.  
...
- the primary property sets the primary color for the theme to a dark brown (#402d20), which is often used for buttons, links, and other interactive elements, providing a visually appealing contrast 
